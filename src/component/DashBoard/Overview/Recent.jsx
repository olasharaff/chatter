import { collection, getDocs, orderBy, query, doc as docs, getDoc } from "firebase/firestore";
  ...
  useEffect(() => {
    async function fetchPostings() {
      try {
        ...
        toast.error("There is error while fetching all your posts");
      }
    }
    fetchPostings();
  }, []);
  ...
  return (
    <div className="">
      {postings.map((posting) => (
        <div className="border" key={posting.id}>
